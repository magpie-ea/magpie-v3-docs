...
### Instruction screen
The [InstructionScreen](https://reference.magpie-experiments.org/#instructionscreen) component displays informational
...
Magpie has some ready-made trial screens built-in for simple experimental trials, all [listed in the reference](https://reference.magpie-experiments.org/#trial-screens).

### Forced choice
The [ForcedChoiceScreen](https://reference.magpie-experiments.org/#forcedchoicescreen) component displays a context,
...
### Image selection
The [ImageSelectionScreen](https://reference.magpie-experiments.org/#imageselectionscreen) realizes another forced choice task, by presenting multiple pictures (arranged horizontally) and
...
### Text box input
The [TextareaScreen](https://reference.magpie-experiments.org/#textareascreen) requires users to type in text freely in a text box.
```html
<TextareaScreen
...
(If you'd like to implement a custom view with these phases, you can use [LifecycleScreen](https://reference.magpie-experiments.org/#lifecyclescreen).)
...
For more details on the available parameters, [refer to the reference on the LifecycleScreen](https://reference.magpie-experiments.org/#lifecyclescreen).


## Special screens
All special screens are [listed in the reference](https://reference.magpie-experiments.org/#screens).

### Post Test Screen
The [PostTestScreen](https://reference.magpie-experiments.org/#posttestscreen) component asks for additional information
...
### SubmitResultsScreen
The [SubmitResultsScreen](https://reference.magpie-experiments.org/#submitresultsscreen) is usually placed at the end
...
[DebugResultsScreen](https://reference.magpie-experiments.org/#debugresultsscreen) and will not submit any data.
...
### DebugResultsScreen
The [DebugResultsScreen](https://reference.magpie-experiments.org/#debugresultsscreen) can be placed at the end of an
